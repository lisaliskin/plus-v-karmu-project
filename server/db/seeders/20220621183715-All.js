...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    const tasks = [
      {name: 'Подружиться коту с собакой', description: 'Подружить кота Васю с соседским псом Мурой',
      img:'https://www.spletnik.ru/img/__post/a1/0cea5c624b2daxl_a1ff3a1fa7c9e9ef6b1a11ea3ffca38c_672.jpg',
      subcategory_id:1, createdAt: new Date(), updatedAt: new Date(),
    },
      {name: 'Подружиться барсу с тигром', description: 'Подружить тигра Волка с соседским барсом Гарегином',
